      ...
      className='w-full lg:h-auto p-4 py-20'>
        <div className='max-w-[1240px] mx-auto flex-col justify-center h-full'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-4 py-4 gap-8'>
            <div
              onClick={handleHtml}
              className={`p-6 rounded-xl ${html ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
            ...
            <div
              onClick={handleCss}
              className={`p-6 rounded-xl ${css ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${javascript ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              onClick={handleNode}
              className={`p-6 rounded-xl ${node ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              onClick={handleReact}
              className={`p-6 rounded-xl ${react ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${github ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${firebase ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${materialUI ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${nextJs ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${tailwind ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${postgres ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${typescript ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              onClick={handleJava}
              className={`p-6 rounded-xl ${java ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${reactNative ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
            ...
            <div
              ...
              className={`p-6 rounded-xl ${spring ? 'border-2 border-black' : 'hover:scale-105 ease-in duration-300 shadow-xl border-2'} cursor-pointer`}
            >
              <div className='grid grid-cols-2 gap-2 justify-center items-center'>
                <div className='m-auto'>
                  <Image
