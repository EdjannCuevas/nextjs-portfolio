...
const Pantry = () => {
    ...
    return (
        <div className='max-w-full max-h-full h-[310px] w-[360px] md:h-[420px] md:w-[550px] lg:h-[560px] lg:w-[820px] m-auto py-16 px-4 hover:scale-95 ease-in duration-300 relative group'>
            <div
