...
const Pantry: React.FC<BookXChangeProps> = ({ handleLink }) => {
    ...
    return (
        <div className='flex flex-col md:flex-col h-[402px] w-[315px] md:h-[250px] md:w-[450px] lg:h-[390px] lg:w-[708px] m-auto relative group'>
            <div className='absolute left-[30%] md:left-0 md:bottom-20 z-50'>
            ...
            <div className="mt-[210px] md:mt-0 md:ml-[70px] aspect-w-16 aspect-h-9">
                <iframe
