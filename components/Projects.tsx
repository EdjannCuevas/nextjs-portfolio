  ...
  return (
    ...
    >
      <div>
        ...
        <div className='max-w-[1240px] m-auto flex flex-col md:grid lg:grid grid-cols-3 pt-4 gap-8'>
          <div className='col-span-1'>
            ...
            <div className='w-full'>
              ...
              <div className='grid grid-cols-2 m-1'>
                <div className='flex items-center m-2 w-[40px] md:w-[45px] rounded shadow-lg shadow-grey-400 cursor-pointer hover:scale-105 ease-in duration-300'>
                  <Image
                    alt='/'
                    src={Javascript}
                  />
